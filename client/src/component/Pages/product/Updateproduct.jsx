            ...
            <div className="form">
              ...
              <form action="" method="POST" encType="multipart/form-data">
                ...
                <div className="parts">
                  <div className="crd">
                    <label>Name</label>
                    <div className="crd-input" id='crud'>
                      <input type="text" placeholder="Name" required name="name" id='input' />
                      <div className="icon">
                ...
                <div className="parts">
                  <div className="crd">
                    ...
                    <div className="crd-input" id='crud'>
                      <input type="password" placeholder="Password" required name="password" id='input' />
                      <div className="icon">
